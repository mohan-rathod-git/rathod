...
import { ShieldCheck, Clock, XCircle, Check, X, Loader2 } from "lucide-react";
...
const AdminVerification = () => {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-foreground mb-6">Verification Requests</h1>
